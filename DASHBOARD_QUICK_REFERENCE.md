...
```
┌─────────────────┬──────────┬────────────┬────────┬──────────┬──────────┬────────────┬────────────────────────┐
│ Rol             │ Zien     │ Drag&Drop  │ Resize │ Aanmaken │ Bewerken │ Verwijderen│ Visibility Opties      │
├─────────────────┼──────────┼────────────┼────────┼──────────┼──────────┼────────────┼────────────────────────┤
│ Klant           │ Everyone │     ✅     │   ❌   │    ❌    │    ❌    │     ❌     │ N/A                    │
│ Medewerker      │ Mdw+Own  │     ✅     │ ✅ Eigen│    ✅    │ ✅ Eigen │  ✅ Eigen  │ Medewerkers, Alleen Ik │
│ Admin           │ Eigen org│     ✅     │ ✅ Alles│    ✅    │ ✅ Alles │  ✅ Alles  │ Iedereen, Mdw, Alleen Ik│
│ Super Admin     │  Org 1   │     ✅     │ ✅ Alles│    ✅    │ ✅ Alles │  ✅ Alles  │ Iedereen, Mdw, Alleen Ik│
└─────────────────┴──────────┴────────────┴────────┴──────────┴──────────┴────────────┴────────────────────────┘
```

### Visibility Uitleg:
- **Iedereen**: Widget zichtbaar voor klanten, medewerkers én admins (alleen admin kan dit instellen)
- **Medewerkers**: Widget alleen zichtbaar voor medewerkers en admins
- **Alleen Ik**: Widget alleen zichtbaar voor de creator
