...
<div class="grid grid-cols-1 gap-4 mb-4">
    <div>
        <label class="block font-medium">Nieuw- testzadel</label>
        <input type="text" name="nieuw_testzadel" class="mt-1 block w-full border-gray-300 rounded" value="{{ old('nieuw_testzadel', $b->nieuw_testzadel ?? '') }}">
    </div>
</div>
