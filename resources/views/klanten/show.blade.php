                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right align-top">
                            ...
                            @if($test->type === 'bikefit')
                                ...
                                @endhasFeature
                            @elseif($test->type === 'document')
                                {{-- Edit/Delete knoppen - ALLEEN voor beheerders en medewerkers met upload rechten --}}
                                {{-- NIET voor klanten! --}}
                                @if($user && !$user->isKlant() && ($user->isBeheerder() || ($user->isMedewerker() && $user->upload_documenten)))
                                <button 
...
{{-- Edit Upload Modal --}}
@include('components.edit-upload-modal')
