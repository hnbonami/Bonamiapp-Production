        ...
        <div class="p-6">
            ...
            <form method="POST" action="{{ route('klanten.store') }}" enctype="multipart/form-data">
                ...
                <h3 class="text-xl font-bold mt-6 mb-4">Overige Informatie</h3>
                                ...
                                <!-- Doorverwijzing Sectie - NIEUW SYSTEEM -->
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (doorverwijzingSelect && referralCustomerSection) {
        function toggleReferralCustomerSection() {
            if (doorverwijzingSelect.value === 'mond_aan_mond') {
                referralCustomerSection.style.display = 'block';
            } else {
                referralCustomerSection.style.display = 'none';
                // Reset selectie
        ...
        doorverwijzingSelect.addEventListener('change', toggleReferralCustomerSection);
        toggleReferralCustomerSection(); // Initial state
    }
});
</script>
@endsection
