...
<head>
    ...
    <title>Wachtwoord Vergeten - {{ config('app.name', 'Bonami app') }}</title>
...
<body>
    <div class="login-container">
        <!-- Linker kant: Wachtwoord vergeten formulier (50%) -->
        <div class="login-form-section">
            <div class="w-full max-w-md">
                ...
                <p class="text-center text-sm mb-8" style="color: {{ $loginTextColor }}">
                    Geen probleem. Geef je e-mailadres op en je ontvangt een link om je wachtwoord te resetten.
                </p>
                ...
                <form method="POST" action="{{ route('password.email') }}" class="space-y-6">
                    ...
                    <div class="text-center text-sm" style="color: {{ $loginTextColor }}">
                        <a 
                            href="{{ route('login') }}" 
                            class="underline hover:no-underline transition"
