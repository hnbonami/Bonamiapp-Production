...
<head>
    ...
    <title>Wachtwoord Resetten - {{ config('app.name', 'Bonami app') }}</title>
...
<body>
    <div class="login-container">
        <!-- Linker kant: Wachtwoord reset formulier (50%) -->
        <div class="login-form-section">
            <div class="w-full max-w-md">
                ...
                <p class="text-center text-sm mb-8" style="color: {{ $loginTextColor }}">
                    Vul je nieuwe wachtwoord in om je account te beveiligen.
                </p>
