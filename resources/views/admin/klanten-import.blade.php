    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                ...
                <h1 class="text-3xl font-bold text-gray-900 mb-6">Klanten Importeren</h1>
                        ...
                        <form action="{{ route('klanten.import') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">
                                    Selecteer Klanten Excel Bestand (.xlsx, .xls, .csv)
                                </label>
                                <input type="file" 
                                       name="file" 
                                       accept=".xlsx,.xls,.csv" 
                            ...
                            <button type="submit" 
                                    class="w-full inline-flex justify-center items-center px-6 py-3 border border-transparent rounded-md font-semibold text-sm text-white uppercase tracking-widest bg-blue-600 hover:bg-blue-700 transition ease-in-out duration-150">
                                📤 Klanten Importeren
                            </button>
                        </form>

                        <div class="mt-6">
                            <a href="{{ route('klanten.template') }}" 
                    ...
                    <div>
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    ...
                                    <ul class="list-disc list-inside text-sm text-yellow-700 mt-2">
                                        ...
                                        <li>Klanten zonder geldige klant worden overgeslagen</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-blue-50 border-l-4 border-blue-400 p-4">
                            ...
                            <ul class="list-disc list-inside text-sm text-blue-700 space-y-1">
                                ...
                                <li><strong>email</strong> (verplicht, uniek)</li>
                                <li><strong>telefoonnummer</strong></li>
                                <li><strong>geboortedatum</strong> (YYYY-MM-DD)</li>
                                <li><strong>geslacht</strong> (Man, Vrouw, Anders)</li>
                                <li><strong>straatnaam, huisnummer</strong></li>
                                <li><strong>postcode, stad</strong></li>
                                <li><strong>sport, niveau, club</strong></li>
                                <li><strong>herkomst</strong></li>
                            </ul>
                        </div>
                        ...
                        <div class="mt-4 bg-green-50 p-4 rounded">
                            <a href="{{ route('klanten.index') }}" 
                               class="inline-flex items-center px-6 py-3 border border-transparent rounded-md font-semibold text-sm text-white uppercase tracking-widest bg-blue-600 hover:bg-blue-700 transition ease-in-out duration-150">
                                👥 Klanten Importeren
                            </a>
                        </div>
                    </div>
